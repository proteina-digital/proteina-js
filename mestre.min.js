console.log("VERSÃO JS 2.7");function desabilitar(){alert("Todos os direitos Reservados. A cópia e reprodução não-autorizada está expressamente proibida.")
return!1}
