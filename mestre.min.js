console.log("VERSÃO JS 2.0");function desabilitar(){alert("Todos os direitos Reservados. A cópia e reprodução não-autorizada está expressamente proibida.")
return!1}
...
function formatNumber(num){var a=num.toString().substring(0,4);var b=num.toString().substring(4,7);var c=num.toString().substring(7,11);return a+" "+b+" "+c}
var muda_tel=function(tel_atual,tel_novo){var tel_novo_clean=tel_novo.replace(/[^0-9]/g,'');var tel_atual_clean=tel_atual.replace(/[^0-9]/g,'');var tel_atual_formatado=formatNumber(tel_atual_clean);var tel_novo_formatado=formatNumber(tel_novo_clean);console.log(tel_novo_clean);console.log(tel_atual_clean);$("a:contains('"+tel_atual_formatado+"')").each(function(){var current_html=$(this).html();$(this).html(current_html.replace(tel_atual_formatado,tel_novo_formatado));$(this).attr('href','tel:'+tel_novo_clean)});$('a[href*="'+tel_atual_clean+'"]').each(function(){$(this).attr('href','tel:'+tel_novo_clean)})};function acao_pelo_tel(tel_atual){if(readCookie('telefone')){if(_GETURL("telefone")){if(readCookie('telefone')==_GETURL("telefone")){muda_tel(tel_atual,_GETURL("telefone"));_CRIAINPUT("utm_source",_GETURL("utm_source"));_CRIAINPUT("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_campaign",_GETURL("utm_campaign"));console.log("A")}else{muda_tel(tel_atual,_GETURL("telefone"));cria_cookie("telefone",_GETURL("telefone"));cria_cookie("utm_campaign",_GETURL("utm_campaign"));cria_cookie("utm_source",_GETURL("utm_source"));cria_cookie("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_source",_GETURL("utm_source"));_CRIAINPUT("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_campaign",_GETURL("utm_campaign"));console.log("B")}}else{muda_tel(tel_atual,readCookie("telefone"));_CRIAINPUT("utm_source",readCookie("utm_source"));_CRIAINPUT("utm_medium",readCookie("utm_medium"));_CRIAINPUT("utm_campaign",readCookie("utm_campaign"));console.log("C")}}else{if(_GETURL("telefone")){muda_tel(tel_atual,_GETURL("telefone"));cria_cookie("telefone",_GETURL("telefone"));cria_cookie("utm_campaign",_GETURL("utm_campaign"));cria_cookie("utm_source",_GETURL("utm_source"));cria_cookie("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_source",_GETURL("utm_source"));_CRIAINPUT("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_campaign",_GETURL("utm_campaign"));console.log("D")}else{_CRIAINPUT("utm_source",'null');_CRIAINPUT("utm_medium",'null');_CRIAINPUT("utm_campaign",'null');console.log("E")}}}
function acao_pela_campanha(tel_atual,campanha_organica){if(readCookie('utm_campaign')){if(_GETURL("utm_campaign")){muda_tel(tel_atual,checa_campanha(_GETURL("utm_campaign")));_CRIAINPUT("site",_GETURL("utm_campaign"));_CRIAINPUT("utm_source",_GETURL("utm_source"));_CRIAINPUT("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_campaign",_GETURL("utm_campaign"));cria_cookie("site",_GETURL("utm_campaign"));cria_cookie("utm_campaign",_GETURL("utm_campaign"));cria_cookie("utm_source",_GETURL("utm_source"));cria_cookie("utm_medium",_GETURL("utm_medium"))}else{muda_tel(tel_atual,checa_campanha(readCookie("utm_campaign")));_CRIAINPUT("site",readCookie("utm_campaign"));_CRIAINPUT("utm_source",readCookie("utm_source"));_CRIAINPUT("utm_medium",readCookie("utm_medium"));_CRIAINPUT("utm_campaign",readCookie("utm_campaign"))}}else{if(_GETURL("utm_campaign")){muda_tel(tel_atual,checa_campanha(_GETURL("utm_campaign")));_CRIAINPUT("site",_GETURL("utm_campaign"));_CRIAINPUT("utm_source",_GETURL("utm_source"));_CRIAINPUT("utm_medium",_GETURL("utm_medium"));_CRIAINPUT("utm_campaign",_GETURL("utm_campaign"));cria_cookie("site",_GETURL("utm_campaign"));cria_cookie("utm_campaign",_GETURL("utm_campaign"));cria_cookie("utm_source",_GETURL("utm_source"));cria_cookie("utm_medium",_GETURL("utm_medium"))}else{_CRIAINPUT("site",campanha_organica);_CRIAINPUT("utm_source",'google');_CRIAINPUT("utm_medium",'organic');_CRIAINPUT("utm_campaign",campanha_organica);cria_cookie("site",campanha_organica);cria_cookie("utm_campaign",campanha_organica);cria_cookie("utm_source",'google');cria_cookie("utm_medium",'organic')}}}
