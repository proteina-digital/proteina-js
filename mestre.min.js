console.log("VERSÃO JS 2.4");function desabilitar(){alert("Todos os direitos Reservados. A cópia e reprodução não-autorizada está expressamente proibida.")
return!1}
...
function fixa_elemento(elemento){var posicao_inicial_elemento=$(elemento).offset().top;var posicao_atual=0;$(window).scroll(function(){var posicao_atual_tela=$(window).scrollTop();if(posicao_atual_tela<=posicao_inicial_elemento){posicao_atual=parseInt(posicao_inicial_elemento-posicao_atual_tela)}else{posicao_atual=posicao_inicial_elemento}
